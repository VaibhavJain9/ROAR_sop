...
for i in range(len(user_data)):
 ...
 y_t = y[l:r]
 z_t = z[l:r]
 learner = ActiveLearner ( estimator= LogisticRegression (class_weight= 'balanced', solver = 'newton-cholesky'))
...
# Step 2: Split temp into active learning (40%) and test (20%)
 ...
 X_active, X_test, y_active, y_test,z_acitve , z_test = train_test_split(X_temp, y_temp,z_temp,  test_size=1/3, random_state=42, shuffle=False)
 ...
 for idx, (data_point, true_label,video_id) in enumerate(zip(X_active, y_active,z_acitve)):
